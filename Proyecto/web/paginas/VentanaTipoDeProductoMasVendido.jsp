<%-- 
    Document   : VentanaTipoDeProductoMasVendido
    Created on : 26-nov-2017, 18:11:08
    Author     : Toragin
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="cl.duoc.dej4501.dao.DetalleVentaImp"%>
<%@page import="cl.duoc.dej4501.dto.Producto"%>
...
<html>
  ...
  <div class="container-fluid">
    ...
    <body>
        <form action="tipoProductMasVendido" method="POST">
